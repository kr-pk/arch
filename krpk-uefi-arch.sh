...
pacman -S xorg-server xorg-xinit xorg-xkill xorg-xsetroot xorg-xbacklight xorg-xprop xf86-video-intel intel-ucode vulkan-intel gvfs mc\
     ...
     emacs rsync firefox dash wireless-tools wpa-supplicant \
     libnotify dunst slock jq reflector \
