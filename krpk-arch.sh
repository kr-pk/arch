...
tar -xf $HOME/dotfiles/dotfiles.tar.gz
rm -rf $HOME/.config
rm -rf $HOME/.local
mv -f ~/dotfiles/dotfiles/.config $HOME
mv -f ~/dotfiles/dotfiles/.local $HOME
rm -rf dotfiles
git clone https://github.com/kr-pk/pix
git clone --depth=1 https://github.com/Bugswriter/dwm
